   ...
   <table>
    <tr>
     <td>
      ...
      <h3><a href="/tools/molecular-dynamics/oligosaccharide-builder/build-glycan">Build an oligosaccharide</a></h3>
     ...
     <td>
      ...
      <h3><a href="/tools/molecular-dynamics/glycoprotein-builder/upload-pdb">Build a glycoprotein</a></h3>
